...
<div class="row align-items-center ">
    ...
    $body = 'Merci de consultez mon profil sur : ' . $link_profile;
    ?>
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row text-center mt-2 py-2">
                    ...
                    <div class="col-6">
                        ...
                        <h3 class="font-weight-normal">
                            <span><?php echo $this->ebook_model->get_status_wise_ebooks_for_instructor(1)->num_rows(); ?></span>
                        </h3>
                        <p class="text-muted mb-0"><?php echo get_phrase('active_ebooks'); ?></p>
                    </div>
                    <div class="col-6">
                        <i class="mdi mdi-trending-down text-warning mt-3 h3"></i>
                        <h3 class="font-weight-normal">
                            <span><?php echo $this->ebook_model->get_status_wise_ebooks_for_instructor(0)->num_rows(); ?></span>
                        </h3>
                        <p class="text-muted mb-0"> <?php echo get_phrase('pending_ebooks'); ?></p>
                    </div>
                </div>
            </div>
        </div>

     ...
     t.prototype.respChart = function(r, a, n, e) {
         ...
         if (0 < o("#project-status-chart").length) {
             t.push(this.respChart(o("#project-status-chart"), "Doughnut", {
                 labels: ["<?php echo get_phrase('active_ebooks'); ?>", "<?php echo get_phrase('pending_ebooks'); ?>"],
                 datasets: [{
                     data: [<?php echo$this->ebook_model->get_status_wise_ebooks_for_instructor(1)->num_rows(); ?>, <?php echo $this->ebook_model->get_status_wise_ebooks_for_instructor(0)->num_rows(); ?>],

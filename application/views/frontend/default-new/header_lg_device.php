  ...
  <div class="container">
    ...
    <div class="navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
          ...
          <ul class="navbarHover">
            ...
            foreach ($categories as $key => $category) : ?>
              <li>
                <a href="<?php echo site_url('ebook?category=' . $category['slug'] . '&price=all&rating=all'); ?>">
                  <i class="fas fa-list-ul px-2"></i>
                  <?= get_phrase($category['title']); ?>
                </a>
              </li>
            <?php endforeach; ?>
            <li>
      ...
      <div class="right-menubar ms-auto">
        ...
        <?php if ($user_login) : ?>
          <li><a class="dropdown-item" href="<?php echo site_url('home/my_ebooks') ?>"><?php echo site_phrase('My Ebooks') ?></a></li>
              ...
              <div class="path-pos">
                ...
                <ul>
                  <?php if ($user_login) : ?>
                    ...
                    <li class="user-dropdown-menu-item"><a href="<?php echo site_url('home/my_ebooks'); ?>"><i class="far fa-gem"></i><?php echo site_phrase('my_ebooks'); ?></a></li>

<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('enrol_history_ebooks'); ?></h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row justify-content-md-center">
                    <div class="col-xl-6">
                        <form class="form-inline" action="<?php echo site_url('admin/enrol_history_ebooks/filter_by_date_range') ?>" method="get">
                            <div class="col-xl-10">
                        ...
                        <table class="table table-striped table-centered mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo get_phrase('enrolled_ebook'); ?></th>
                            ...
                            <tbody>
                                <?php foreach ($enrol_history->result_array() as $enrol) :
                                    ...
                                    $ebook_data = $this->db->get_where('ebook', array('ebook_id' => $enrol['ebook_id']))->row_array(); ?>
                                    <tr class="gradeU">
                                        <td>
                                        ...
                                        <td>
                                            <strong>
                                                <a href="<?php echo site_url('addons/ebook_manager/edit_ebook/' . $ebook_data['ebook_id']); ?>" target="_blank">
                                                    <?php echo $ebook_data['title']; ?>
                                                </a>
                                            </strong>
                                        </td>
                                        <td><?php echo date('D, d M Y', $enrol['added_date']); ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>

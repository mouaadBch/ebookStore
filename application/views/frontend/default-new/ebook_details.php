    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-4" style="position: relative;">
                <?php if (isset($ebook_details['video_url'])) { ?>
                    <div class="card-video-icon" style="    background-color: rgba(0, 0, 0, 0.355);display: inline-block;border-radius: 50%;position: absolute;top: 39%;left: 41%;cursor: pointer;" onclick="ebookVideo()">
                        <i class="fa-solid fa-play" style="color: #fff;font-size: 20px;padding: 16px 20px;"></i>
                    </div>
                <?php } ?>
                <div class="ebook-img"><img src="<?php echo base_url('uploads/ebook/thumbnails/' . $ebook_details['thumbnail']) ?>" alt="" width="100%" /></div>
            </div>
            <div class="col-lg-8">
                ...
                <div class="ebook-content mt-4 position-relative">
                    ...
                    if ($ebook_details['is_free']) :
                        ...
                        <?php } else { ?>
                            ...
                            <p class="position-absolute top-100 start-0 text-danger">* Log in to view the ebook</p>
                        <?php }
                        ?>
                    <?php else : ?>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="ebook-modal d-grid justify-content-center">
                            <?php if (!empty($ebook_details['preview'])) : ?>
                                <object data="<?php echo base_url('uploads/ebook/file/ebook_preview/' . $ebook_details['preview'] . '#toolbar=0') ?>" height="500px" width="800px"></object>
                            <?php else : ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="plyr__video-embed" id="player">
                        <iframe height="500" src="<?php echo $ebook_details['video_url']; ?>?origin=https://plyr.io&amp;iv_load_policy=3&amp;modestbranding=1&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;enablejsapi=1" allowfullscreen allowtransparency></iframe>
                    </div>

      ...
      <div class="flex-shrink-0 mt-3">
        <ul class="list-unstyled ps-0">
          ...
          <?php elseif($user_login): ?>
            <li class="bg-light"><a class="btn btn-toggle-list d-inline-flex align-items-center rounded border-0 text-dark text-16px fw-500" href="<?php echo site_url('home/my_ebooks'); ?>"><i class="far fa-gem me-2"></i><?php echo site_phrase('my_ebooks'); ?></a></li>

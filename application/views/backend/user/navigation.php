	...
	<ul class="metismenu side-nav side-nav-light">
		...
		<?php if (get_settings('allow_instructor') == 1) : ?>
			<?php if ($this->session->userdata('is_instructor')) : ?>
				...
				<li class="side-nav-item">
					<a href="<?php echo site_url('addons/ebook_manager/ebook'); ?>" class="side-nav-link <?php if ($page_name == 'all_ebooks' || $page_name == 'ebook_edit') echo 'active'; ?>">
					<i class="fas fa-book"></i>
						<span><?php echo get_phrase('all_ebooks'); ?></span>
					</a>
				</li>

				
				<li class="side-nav-item">
					<a href="<?php echo site_url('ebook_manager/add_ebook'); ?>" class="side-nav-link <?php if ($page_name == 'add_ebook' ) echo 'active'; ?>">
					<i class="fas fa-plus"></i>
						<span><?php echo get_phrase('add_ebook'); ?></span>
					</a>
				</li>
				
				<li class="side-nav-item">
					<a href="<?php echo site_url('addons/ebook_manager/payment_history/instructor_revenue'); ?>" class="side-nav-link <?php if ($page_name == 'ebook_instructor_revenue') echo 'active'; ?>">
